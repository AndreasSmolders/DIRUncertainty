...
for i in range (1,34):
    ...
    movingImagePath = os.path.join(basePath,patient,'Fr{i}/sCT.mha')
    vectorfieldPath =  os.path.join(basePath,patient,'Fr{i}/my_output_vf')
    ...
    for typeOfWorkflow in typeOfWorkflows: 
        ...
        print(fixedImage.getShape())
        print(movingImage.getShape())
        print(fixedDVF.getShape())
